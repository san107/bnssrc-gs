import { ItsonCtl } from '@/app/(admin)/comp/gatectl/itson/ItsonCtl';
...
export const DlgItson = React.forwardRef<Props, unknown>((props, ref) => {
  ...
  return (
    <React.Fragment>
      <BootstrapDialog onClose={handleClose} open={open}>
        <DlgTitle title='이츠온 제어' handleClose={handleClose} />

        <ItsonCtl gateSeq={open ? gateSeq : undefined} onClose={handleClose} />
      </BootstrapDialog>
    </React.Fragment>
  );
});

DlgItson.displayName = 'DlgItson';
export const useDlgItson = () => useRefComponent<Props>(DlgItson);
